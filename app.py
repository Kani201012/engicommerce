...
# --- 1. APP CONFIGURATION ---
st.set_page_config(page_title="Kaydiem Titan v12.0 | Final Authority Architect", layout="wide", page_icon="💎")
...
with st.sidebar:
    ...
    with st.expander("🎭 1. Layout & DNA", expanded=True):
        layout_dna = st.selectbox("Design DNA", ["Classic Royal", "Industrial Titan", "Soft-UI", "Glass-Tech", "Corporate Elite"])
...
st.title("🏗️ Kaydiem Titan Supreme v12.0")
...
with tabs[3]:
    ...
    st.warning("IMPORTANT: Use the Pipe (|) separator in your sheet. Format: Name | Price | Description | Img1 | Img2 | Img3")
...
if st.button("🚀 DEPLOY 100% MARKET-DOMINATING ASSET"):
    ...
    * {{ box-sizing: border-box; }}
    ...
    def get_layout(title_tag, desc_tag, body_html, is_h=False):
        ...
        # --- RECTIFIED DYNAMIC SHOWROOM SCRIPT (v12.0) ---
        dynamic_script = ""
...
<body class="bg-white flex flex-col min-h-screen">
    ...
    st.success("💎 TITAN SUPREME v12.0 FINAL PLATINUM DEPLOYED. World-Class Build Confirmed.")
    st.download_button("📥 DOWNLOAD COMPLETE BIZ PACKAGE", z_b.getvalue(), f"{biz_name.lower().replace(' ', '_')}_v12_0.zip")
